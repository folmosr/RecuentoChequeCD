...
#Region "Methods"
    ...
    '// 02-18-97
    Public Declare Function BUICCloseImageWindow Lib "BUICAP32.DLL" (ByVal iWindow As Integer) As Integer

    '// 02-18-97
    Public Declare Function BUICCombineTIFFS Lib "BUICAP32.DLL" (ByVal InputFile As String, ByVal OutputFile As String) As Integer

    '// 02-18-97
    Public Declare Function BUICCompressImage Lib "BUICAP32.DLL" (ByVal psFilename As String, ByVal pchugeImage As Integer) As Integer

    '// 02-18-97
    Public Declare Function BUICCompressImageGray Lib "BUICAP32.DLL" (ByVal psFilename As String, ByVal pchugeImage As Integer) As Integer

    '// 02-18-97
    Public Declare Function BUICCopyFile Lib "BUICAP32.DLL" (ByVal InputFile As String, ByVal OutputFile As String) As Integer

    '// 02-18-97
    Public Declare Function BUICCropFile Lib "BUICAP32.DLL" (ByVal InputFile As String, ByVal OutpoutFile As String, ByVal Margin As Short) As Integer

    '// 02-18-97
    Public Declare Function BUICDebug Lib "BUICAP32.DLL" (ByVal iState As Integer) As Integer

    '// 02-18-97
    Public Declare Function BUICDisplayAbout Lib "BUICAP32.DLL" () As Integer

    '// 02-18-97
    Public Declare Function BUICDisplayStatus Lib "BUICAP32.DLL" () As Integer

    '// 01-21-99
    Public Declare Function BUICEjectDocument Lib "BUICAP32.DLL" () As Integer

    '// 02-18-97
    Public Declare Function BUICExit Lib "BUICAP32.DLL" () As Integer

    '// 02-18-97
    Public Declare Function BUICGetMicrLine Lib "BUICAP32.DLL" (ByVal InputFile As String, ByVal iPage As Short, ByVal MicrLine As String, ByVal MicrLineSize As Short) As Integer

    '// 02-18-97
    Public Declare Function BUICGetParam Lib "BUICAP32.DLL" (ByVal iParam As Integer) As Integer

    '// 02-18-97
    Public Declare Function BUICGetScannerInfo Lib "BUICAP32.DLL" (ByRef pbAdapter As Byte, ByRef pbTargetID As Byte, ByVal pcVendor As String, ByVal pcProduct As String, ByVal pcRelease As String, ByVal iMessageBox As Integer) As Integer

    '// 01-30-02 JB
    Public Declare Function BUICGetScannerSerialNumber Lib "BUICAP32.DLL" (ByVal pcSerialNumber As String, ByRef puiDocumentNumber As Integer, ByRef puiTime As Integer) As Integer

    '// 02-18-97
    Public Declare Function BUICGetTiffPages Lib "BUICAP32.DLL" (ByVal InputFile As String) As Integer

    '// Function Declares
    Public Declare Function BUICInit Lib "BUICAP32.DLL" () As Integer

    '// 02-18-97
    Public Declare Function BUICInitPath Lib "BUICAP32.DLL" (ByVal sDLLPath As String, ByVal sININame As String, ByVal sCfgFileName As String) As Integer

    '// 02-18-97
    Public Declare Function BUICReadConfig Lib "BUICAP32.DLL" (ByVal lpFilename As String) As Integer

    '// JOA
    Public Declare Function BUICScan Lib "BUICAP32.DLL" (ByVal iJob As Integer, ByVal lpFront As String, ByVal strFLen As String, ByVal lpBack As String, ByVal strBLen As String, ByVal LpCode As String, ByVal LpLen As String) As Integer

    '// 02-18-97
    Public Declare Function BUICScanGray Lib "BUICAP32.DLL" (ByVal iJob As Integer, ByVal lpFront As String, ByVal strFLen As String, ByVal lpBack As String, ByVal strBLen As String, ByVal LpCode As String, ByVal LpLen As String, ByVal iImageFmt As Integer) As Integer

    '// 02-18-97
    Public Declare Function BUICScanMemory Lib "BUICAP32.DLL" (ByVal iJob As Integer, ByVal lpFront As Integer, ByVal strFLen As String, ByVal lpBack As Integer, ByVal strBLen As String, ByVal LpCode As String, ByVal LpLen As String) As Integer

    '// 02-18-97
    Public Declare Function BUICScanMemoryGray Lib "BUICAP32.DLL" (ByVal iJob As Integer, ByVal lpFront As Integer, ByVal strFLen As String, ByVal lpBack As Integer, ByVal strBLen As String, ByVal LpCode As String, ByVal LpLen As String, ByVal iImageFmt As Integer) As Integer

    '// 02-18-97
    Public Declare Function BUICSetImageMultPage Lib "BUICAP32.DLL" (ByVal sFile As String, ByVal iPage As Integer, ByVal iWindow As Integer) As Integer

    '// 02-18-97
    Public Declare Function BUICSetMicrLine Lib "BUICAP32.DLL" (ByVal InputFile As String, ByVal iPage As Short, ByVal MicrLine As String, ByVal MicrLineSize As Short, ByVal OutputFile As String) As Integer

    '// 02-18-97
    Public Declare Function BUICSetParam Lib "BUICAP32.DLL" (ByVal iParam As Integer, ByVal iValue As Integer) As Integer

    '// 11-11-02 JB
    Public Declare Function BUICSetParamString Lib "BUICAP32.DLL" (ByVal iParameter As Integer, ByVal sString As String) As Integer

    '// 02-18-97
    Public Declare Function BUICSizeImageWindow Lib "BUICAP32.DLL" (ByVal iWindow As Integer) As Integer

    '// 07-17-97
    Public Declare Function BUICStartImageWindow Lib "BUICAP32.DLL" (ByVal hWnd As Integer, ByVal iWindow As Integer) As Integer

    '// 02-18-97
    Public Declare Function BUICStatus Lib "BUICAP32.DLL" () As Integer

    '// 02-18-97
    Public Declare Function BUICUpdateMicrLine Lib "BUICAP32.DLL" (ByVal InputFile As String, ByVal MicrLine As String, ByVal MicrLineSize As Short) As Integer

    '// 02-18-97
    Public Declare Function BUICWriteConfig Lib "BUICAP32.DLL" (ByVal lpFilename As String) As Integer

    '// 01-01-02 JB
    Public Declare Function CheckEndorsementEnd Lib "BUICAP32.DLL" (ByVal iScannerType As Integer, ByVal BMPFileName As String) As Integer

    '// 02-18-97
    Public Declare Function CheckEndorsementInvert Lib "BUICAP32.DLL" (ByVal iValue As Integer) As Integer

    '// 04-08-98
    Public Declare Function CheckEndorsementStart Lib "BUICAP32.DLL" (ByVal iScannerType As Integer, ByVal iBMPLength As Integer) As Integer

    '// 01-01-02 JB
    Public Declare Function CheckEndorsementText Lib "BUICAP32.DLL" (ByVal iScannerType As Integer, ByVal iTextHeight As Integer, ByVal iXOffset As Integer, ByVal iYOffset As Integer, ByVal iBold As Integer, ByVal iItalic As Integer, ByVal strFont As String, ByVal strText As String) As Integer

    '// 01-30-02 JB
    Public Declare Function DCCAPISupportedScanners Lib "BUICAP32.DLL" () As Integer

    '// 01-01-02 JB
    Public Declare Function DCCAPIVersion Lib "BUICAP32.DLL" () As Integer

    '// 12-02-04 JB
    Public Declare Function DCCLoadImage Lib "BUICAP32.DLL" (ByVal pszImageName As String, ByVal iPage As Integer, ByVal pcDCCImage As Integer, ByVal iMaxImageSize As Integer) As Integer
    ...
    '// 01-01-02 JB
    Public Declare Function FindE13BMicr Lib "BUICAP32.DLL" (ByVal szCheckFileName As String, ByVal iPage As Integer, ByVal iRotate As Integer, ByVal szOCRMicr As String, ByVal szOCRConfidence As String) As Integer

    '// 11-11-02 JB
    Public Declare Function FindE13BMicrMem Lib "BUICAP32.DLL" (ByVal pMem As Integer, ByVal szOCRMicr As String, ByVal szOCRConfidence As String) As Integer

    '// 11-22-00 JB
    Public Declare Function funcConvGrayImageEdgeDetectBW Lib "BUICAP32.DLL" (ByVal pcImage As Integer, ByVal pszFileName As String, ByVal iEdgeThreshold As Integer, ByVal iTwoD As Integer) As Integer

    '// 11-22-00 JB
    Public Declare Function funcConvImageToFile Lib "BUICAP32.DLL" (ByVal pcImage As Integer, ByVal iEdgeThreshold As Integer, ByVal iScale As Integer, ByVal iOutputBits As Integer, ByVal iImageFormat As Integer, ByVal pszFileName As String) As Integer

    '// 02-18-97
    Public Declare Function funcFindBUICScanner Lib "BUICAP32.DLL" (ByVal wNumSCSIAdapters As Object, ByRef pbAdapter As Byte, ByRef pbTargetID As Byte) As Integer

    '// 02-18-97
    Public Declare Function funcLoadPrinterFont Lib "BUICAP32.DLL" (ByVal pcPrinterFontFileName As String) As Integer

    '// 04-08-98
    Public Declare Function funcSendPrinterString Lib "BUICAP32.DLL" (ByVal shPosition As Short, ByVal psString As String, ByVal iMode As Integer) As Integer

    '// 01-21-99
    Public Declare Function funcSetPocket Lib "BUICAP32.DLL" (ByVal iPocket As Integer) As Integer

    '// 01-01-02 JB
    Public Declare Function funcSetUpCallBack Lib "BUICAP32.DLL" (ByVal nEvent As Integer, ByVal CallBackFunction As MyFunc) As Integer

    '// 11-22-00 JB
    Public Declare Function funcTS200GetMICR Lib "BUICAP32.DLL" (ByVal psMICR As String, ByVal iMaxMICR As Integer) As Integer

    '// 01-01-02 JB
    Public Declare Function funcTS200Update Lib "BUICAP32.DLL" (ByVal iOptions As Integer) As Integer

    '// 01-01-02 JB
    Public Declare Function funcTS400ClearPrint Lib "BUICAP32.DLL" (ByVal iStartPosition As Integer, ByVal iEndPosition As Integer) As Integer

    '// 01-01-02 JB
    Public Declare Function funcTS400GetScannerRunInfo Lib "BUICAP32.DLL" (ByRef puiWorkMinutes As Integer, ByRef puiNumDocs As Integer) As Integer

    '// 01-01-02 JB
    Public Declare Function funcTS400ScanRead Lib "BUICAP32.DLL" (ByVal iJob As Integer, ByRef plFrontFileSize As Integer, ByRef plBackFileSize As Integer, ByVal pcCodeLine As String, ByRef piCodeLineSize As Integer, ByVal pcFrontFileName As String, ByVal pcBackFileName As String, ByVal pchOutFrontImage As String, ByVal pchOutBackImage As String, ByVal iMemory As Integer, ByVal iImageFormat As Integer) As Integer

    '// 01-01-02 JB
    Public Declare Function funcTS400ScanReadExit Lib "BUICAP32.DLL" () As Integer

    '// 11-22-00 JB
    Public Declare Function funcTS400ScanReadInit Lib "BUICAP32.DLL" () As Integer

    '// 02-18-97
    Public Declare Function funcTS400SetLoadFont Lib "BUICAP32.DLL" (ByVal iParameter As Integer, ByVal iInputValue As Integer, ByVal FontFile As String) As Integer
    ...
    Public Declare Function funcTS400SetPrint Lib "BUICAP32.DLL" (ByVal iParameter As Integer, ByVal iInputValue As Integer, ByVal InputString_Renamed As String) As Integer

    '// 02-18-97
    Public Declare Function funcTS400SetSorter Lib "BUICAP32.DLL" (ByVal iSorterAlgorithm As Integer, ByVal pbSortString1 As String, ByVal pbSortString2 As String) As Integer

    '// 07-17-97
    Public Declare Function GetScannerType Lib "BUICAP32.DLL" () As Integer

    '// 11-11-02 JB
    Public Declare Function LastCheckMicrStatus Lib "BUICAP32.DLL" () As Integer
    ...
    '// 02-18-97
    Public Declare Function TS400SetPocket Lib "BUICAP32.DLL" (ByVal iPocket As Integer) As Integer

    '// 11-11-02 JB
    Public Declare Function VerifyMicr Lib "BUICAP32.DLL" (ByVal szMagneticMicr As String, ByVal szOCRMicr As String, ByVal szOCRMicrConfidence As String, ByVal szResults As String, ByVal iMaxMagneticErrors As Integer) As Integer
